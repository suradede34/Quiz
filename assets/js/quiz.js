...
const Quiz = document.querySelector('#quizzes');
...
document.querySelector("#html-btn").addEventListener("click", () => loadQuiz("HTML"));
document.querySelector("#css-btn").addEventListener("click", () => loadQuiz("CSS"));
document.querySelector("#js-btn").addEventListener("click", () => loadQuiz("JavaScript"));
document.querySelector("#accessibility-btn").addEventListener("click", () => loadQuiz("Accessibility"));